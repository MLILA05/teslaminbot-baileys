    ...
    const processNotification = async (node) => {
        ...
        switch (nodeType) {
            ...
            case 'link_code_companion_reg': {
                ...
                // WhatsApp also broadcasts an informational notification to existing sessions
                // when a new companion_hello is initiated. These lack primary_identity_pub.
                // Only process notifications that contain the full pairing payload.
                const primaryIdentityPubBuf = getBinaryNodeChildBuffer(linkCodeCompanionReg, 'primary_identity_pub');
                if (!primaryIdentityPubBuf) {
                    break;
                }
                const primaryIdentityPublicKey = toRequiredBuffer(primaryIdentityPubBuf);
